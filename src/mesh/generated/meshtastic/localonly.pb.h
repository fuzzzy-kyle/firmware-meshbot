...
#define meshtastic_LocalModuleConfig_bot_tag     15
...
X(a, STATIC,   OPTIONAL, MESSAGE,  bot,              15)
...
#define meshtastic_LocalModuleConfig_bot_MSGTYPE meshtastic_ModuleConfig_BotConfig
