...
/* Config for the Bot Module - Automated chatbot functionality */
typedef struct _meshtastic_ModuleConfig_BotConfig {
    /* Enable the Bot Module */
    bool enabled;
    /* Minimum seconds between responses to the same user (rate limiting) */
    uint32_t rate_limit_seconds;
    /* If true, respond to all users. If false, only respond to users in allow list */
    bool respond_to_all;
    /* Custom response for !info command (max 200 chars). If empty, uses default */
    char info_response[200];
    /* Custom response for !help command (max 200 chars). If empty, uses default */
    char help_response[200];
} meshtastic_ModuleConfig_BotConfig;
...
typedef struct _meshtastic_ModuleConfig {
    ...
    union {
        ...
        /* Bot Module Config */
        meshtastic_ModuleConfig_BotConfig bot;
    } payload_variant;
...
#define meshtastic_ModuleConfig_BotConfig_init_default {0, 0, 0, "", ""}
...
#define meshtastic_ModuleConfig_BotConfig_init_zero {0, 0, 0, "", ""}
...
#define meshtastic_ModuleConfig_BotConfig_enabled_tag 1
#define meshtastic_ModuleConfig_BotConfig_rate_limit_seconds_tag 2
#define meshtastic_ModuleConfig_BotConfig_respond_to_all_tag 3
#define meshtastic_ModuleConfig_BotConfig_info_response_tag 4
#define meshtastic_ModuleConfig_BotConfig_help_response_tag 5
...
#define meshtastic_ModuleConfig_bot_tag          14
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload_variant,bot,payload_variant.bot),  14)
...
#define meshtastic_ModuleConfig_payload_variant_bot_MSGTYPE meshtastic_ModuleConfig_BotConfig
...
#define meshtastic_ModuleConfig_BotConfig_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BOOL,     enabled,           1) \
X(a, STATIC,   SINGULAR, UINT32,   rate_limit_seconds,   2) \
X(a, STATIC,   SINGULAR, BOOL,     respond_to_all,    3) \
X(a, STATIC,   SINGULAR, STRING,   info_response,     4) \
X(a, STATIC,   SINGULAR, STRING,   help_response,     5)
#define meshtastic_ModuleConfig_BotConfig_CALLBACK NULL
#define meshtastic_ModuleConfig_BotConfig_DEFAULT NULL
...
extern const pb_msgdesc_t meshtastic_ModuleConfig_BotConfig_msg;
...
#define meshtastic_ModuleConfig_BotConfig_fields &meshtastic_ModuleConfig_BotConfig_msg
...
#define meshtastic_ModuleConfig_BotConfig_size   414
...
#define meshtastic_ModuleConfig_size             417
